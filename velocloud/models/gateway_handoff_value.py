...
from velocloud.models.gateway_handoff_value_segments import GatewayHandoffValueSegments
...
class CommunityMapping:
    ...
    This is a custom class.
    """
    enabled: bool = False  # API has default
...
@dataclass
class GatewayHandoffValue:
    """Gateway Handoff Value"""
    segments: GatewayHandoffValueSegments = None
